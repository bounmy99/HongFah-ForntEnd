...
import TableTotalSale from '../../components/TableTotalSale';
...
const columns = [
  {
    ...
    cell: row => (
      <div className="user-image">
        <div className="image">
          <img src={Profile2} alt={row.image} width={50} height={50} />
        </div>
      </div>
    ),
    sortable: true,
...
const column = [
  ...
  },
  {
    ...
    cell: row => (
      <div>
        <p style={{color:'#C44800'}}>{row.status}</p>
      </div>
    ),
    width: '118px'
  },
  ...
  return (
    <div className="card-main">
          <div className="employee-table">
            ...
            { tablechange === 1 && <TableTotalSale columns={columns} OrderList={OrderList} customStyles={customStyles}/>}
            { tablechange === 2 && <TableTotalSale columns={column} OrderList={NotkeepTotal} customStyles={customStyles}/>}
          </div>
    </div>
  )
}
